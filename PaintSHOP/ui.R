...
shinyUI(fluidPage(
    ...
    navbarPage("PaintSHOP",
      tabPanel("About",
        ...
        tags$h4("If you use PaintSHOP in your research, please cite our paper: ",
                tags$a("https://doi.org/10.1038/s41592-021-01187-3", href = "https://doi.org/10.1038/s41592-021-01187-3", target = "_blank")),
        tags$br(),
      ),
        ...
        sidebarLayout(
          sidebarPanel(
            selectInput("probeset", "Choose Probe Set:", c(
              ...
              "ce11 newBalance" = "v1.2/probes/refseq/ce11_refseq_newBalance.tsv",
              "danRer11 newBalance" = "v1.2/probes/refseq/danRer11_refseq_newBalance.tsv",
              "TAIR10 newBalance" = "v1.2/probes/refseq/TAIR10_refseq_newBalance.tsv",
              "sacCer3 newBalance" = "v1.2/probes/refseq/sacCer3_refseq_newBalance.tsv",
              "rn6 newBalance" = "v1.2/probes/refseq/rn6_refseq_newBalance.tsv",
              "galGal5 newBalance" = "v1.2/probes/refseq/galGal5_refseq_newBalance.tsv",
              "galGal6 newBalance" = "v1.2/probes/refseq/galGal6_refseq_newBalance.tsv",
              "OligoMiner hg38 balance" = "v1.2/probes/refseq/hg38b_refseq_newBalance.tsv",
              "OligoMiner hg19 balance" = "v1.2/probes/refseq/hg19b_refseq_newBalance.tsv",
              "2012 Oligopaints hg19" = "v1.2/probes/refseq/hg19_2012_refseq_newBalance.tsv",
              ...
              "ce11 newBalance (isoform-flattened)" = "v1.2/probes/iso/ce11_iso_newBalance.tsv",
              "danRer11 newBalance (isoform-flattened)" = "v1.2/probes/iso/danRer11_iso_newBalance.tsv",
              "TAIR10 newBalance (isoform-flattened)" = "v1.2/probes/iso/TAIR10_iso_newBalance.tsv",
              "sacCer3 newBalance (isoform-flattened)" = "v1.2/probes/iso/sacCer3_iso_newBalance.tsv",
              "rn6 newBalance (isoform-flattened)" = "v1.2/probes/iso/rn6_iso_newBalance.tsv",
              "galGal5 newBalance (isoform-flattened)" = "v1.2/probes/iso/galGal5_iso_newBalance.tsv",
              "galGal6 newBalance (isoform-flattened)" = "v1.2/probes/iso/galGal6_iso_newBalance.tsv",
              "OligoMiner hg38 balance (isoform-flattened)" = "v1.2/probes/iso/hg38b_iso_newBalance.tsv",
              "OligoMiner hg19 balance (isoform-flattened)" = "v1.2/probes/iso/hg19b_iso_newBalance.tsv",
              "2012 Oligopaints hg19 (isoform-flattened)" = "v1.2/probes/iso/hg19_2012_iso_newBalance.tsv",
              "iFISH4U 40-mer hg19 (isoform-flattened)" = "v1.2/probes/iso/iFISH4U_iso_newBalance.tsv"
            )),
            ...
            tags$p("Please upload a text file with one RefSeq accession per line.",
                   ...
                   "..."),
            tags$hr(),
            splitLayout(tags$h3("Advanced Probe Settings (optional)"),
                        actionButton("rna_advanced_popover", label = "?"),
                        cellWidths = c("90%", "10%")),
            shinyBS::bsPopover(id = "rna_advanced_popover",
                               title = "Quick tip:",
                               content = c("For more information on the parameters, ", 
                                           "see the Advanced Probe Settings section in the documentation.",
                                           " After selecting a slider, use arrow keys to set precise values."),
                               placement = "bottom",
                               trigger = "click"),
            radioButtons("repeat_seq", "Repeat:",
                         c("allowed" = TRUE, "none" = FALSE),
                         selected = FALSE),
            sliderInput("off_target", "Max Off-Target Score:",
                        min = 0, max = 10000,
                        value = 200),
            sliderInput("max_kmer", "Max K-mer Count:",
                        min = 0, max = 255,
                        value = 5),
            sliderInput("min_prob", "Min Prob Value:",
                        min = 0.0, max = 1.0,
                        value = 0.0),
            actionButton("restore_default", label = "Restore Default Parameters"),
            tags$hr(),
            splitLayout(tags$h3("Optimize Set (optional)"),
                        actionButton("rna_balanced_popover", label = "?"),
                        cellWidths = c("90%", "10%")),
            shinyBS::bsPopover(id = "rna_balanced_popover",
                               title = "Quick tip:",
                               content = c("For more information on this feature, ", 
                                           "see the Optimizing a Probe Set section in the documentation."),
                               placement = "bottom",
                               trigger = "click"),
         ...
         sidebarPanel(
           ...
           selectInput("probeset_coord", "Choose Probe Set:",
                       c("Chlamydomonas reinhardtii" = "~/Downloads/PaintSHOP_pipeline/example_run/pipeline_output/03_output_files/01_dna_probes/Chlamydomonas_reinhardtii_all_newBalance",
                         ...
                         "ce11 newBalance" = "v1.2/probes/all/ce11_all_newBalance",
                         "danRer11 newBalance" = "v1.2/probes/all/danRer11_all_newBalance",
                         "TAIR10 newBalance" = "v1.2/probes/all/TAIR10_all_newBalance",
                         "sacCer3 newBalance" = "v1.2/probes/all/sacCer3_all_newBalance",
                         "rn6 newBalance" = "v1.2/probes/all/rn6_all_newBalance",
                         "galGal5 newBalance" = "v1.2/probes/all/galGal5_all_newBalance",
                         "galGal6 newBalance" = "v1.2/probes/all/galGal6_all_newBalance",
                         "OligoMiner hg38 balance" = "v1.2/probes/all/hg38b_all",
                         "OligoMiner hg19 balance" = "v1.2/probes/all/hg19b_all",
           ...
           tags$hr(),
           splitLayout(tags$h3("Advanced Probe Settings (optional)"),
                       actionButton("dna_advanced_popover", label = "?"),
                       cellWidths = c("90%", "10%")),
           shinyBS::bsPopover(id = "dna_advanced_popover",
                              title = "Quick tip:",
                              content = c("For more information on the parameters, ", 
                                          "see the Advanced Probe Settings section in the documentation.",
                                          " After selecting a slider, use arrow keys to set precise values."),
           ...
           radioButtons("repeat_seq_coord", "Repeat:",
                        c("allowed" = TRUE, "none" = FALSE),
                        selected = FALSE),
           sliderInput("off_target_coord", "Max Off-Target Score:",
                       min = 0, max = 10000,
                       value = 200),
           sliderInput("max_kmer_coord", "Max K-mer Count:",
                       min = 0, max = 255,
                       value = 5),
           sliderInput("min_prob_coord", "Min Prob Value:",
                       min = 0.0, max = 1.0,
                       value = 0.0),
           actionButton("coord_restore_default", label = "Restore Default Parameters"),
           tags$hr(),
           splitLayout(tags$h3("Optimize Set (optional)"),
                       actionButton("dna_balanced_popover", label = "?"),
                       cellWidths = c("90%", "10%")),
           shinyBS::bsPopover(id = "dna_balanced_popover",
                              title = "Quick tip:",
                              content = c("For more information on this feature, ", 
                                          "see the Optimizing a Probe Set section in the documentation."),
                              placement = "bottom",
         ...
         sidebarPanel(
           ...
           hidden(selectInput("fpb_sequence_select", label = "Select Sequence Set", 
                              choices = list("PaintSHOP 5' Bridge Set" = "appending/ps_fpb.tsv",
                                             ...
                                             "Kishi et al. 2019 Bridges" = "appending/Kishi2019_bridges.tsv",
      ...
      tabPanel("Resources Available",
               tags$h4("As part of our effort to provide open resources for the oligo-FISH community, 
                        ...
                        for download here:"),
               tags$br(),
               div(tags$h4(tags$a('Resources Link', href = 'https://github.com/beliveau-lab/PaintSHOP_resources',
                              target = '_blank')),
                   style="text-align: center;"),
               tags$br(),
               tags$br(),
      ...
      tabPanel("Documentation",
        ...
        bsCollapse(id = "tutorial_collapse", multiple = TRUE,
          bsCollapsePanel("RNA Probe Design", 
                         ...
                         tags$br(),
                         tags$br(),
                         "RNA probe tables have the following columns: ",
                         tags$hr(),
                         "Isoform-resolved RNA probe sets:",
                         tags$br(),
                         tags$br(),
                         tags$b("refseq:"), 
                         " The transcript ID of the transcript that the probe targets, stripped of any version suffixes e.g. NM_001180043",
                         tags$br(),
                         tags$b("chrom:"), 
                         ...
                         tags$br(),
                         tags$b("prob:"),
                         " The probability that the probe has no secondary structure",
                         tags$br(),
                         tags$b("max_kmer:"), 
                         ...
                         tags$br(),
                         tags$b("transcript_id:"), 
                         " The unmodified transcript ID of the transcript that the probe targets e.g. NM_001180043.1",
                         tags$br(),
                         tags$b("gene_id:"), 
                         " The gene ID of the gene whose transcript the probe targets e.g. PAU8",
                         tags$br(),
                         tags$br(),
                         ...
                         tags$br(),
                         tags$b("transcripts:"), 
                         " The number of isoforms that this probe targets",
                         tags$br(),
                         tags$hr(),
                         tags$b("Note:"), 
                         ...
                         tags$h3("Probe Sets:"),
                         tags$br(),
                         tags$b("newBalance (RNA):"), "probe sets for the hg38, hg19, mm10, mm9, dm6, ce11, danRer11, TAIR10, sacCer3, rn6, galGal5, and galGal6 genomes",
                         ...
                         "for the hg38 and hg19 reference genomes. These probes have a length window of ",
                         ...
                         "RefSeq for their respective reference genomes in order to provide quick ",
                         ...
                         tags$br(),
                         tags$br(),
                         "We have now added a new set of 'isoform flattened' probe sets for RNA FISH ",
                         "probe design. These ‘isoform flattened’ annotation sets prioritize shared ",
                         "exonic sequence between isoforms (Methods) in order to maximize the chance ",
                         "of detection and only modestly reduce the coverage of the transcriptome when ",
                         "used for probe intersects. These sets exist with the newBalance probes ",
                         "for the hg38, hg19, mm10, dm6, ce11, danRer11, TAIR10, sacCer3, rn6, galGal5, and galGal6 reference genomes.",
          ...
          bsCollapsePanel("DNA Probe Design", 
                         ...
                         tags$h3("Probe Sets:"),
                         tags$br(),
                         tags$b("newBalance (DNA):"), "probe sets for the hg38, hg19, mm10, mm9, dm6, ce11, danRer11, TAIR10, sacCer3, rn6, galGal5, and galGal6 genomes",
                         "with a length window of 30-37 nucleotides and a Tm of window of 42-47 degrees. These parameters ",
                         "were selected to optimize probe coverage and hybridization. ",
                         "For more information on these new probe sets, please refer to the PaintSHOP manuscript.",
                         tags$br(),
          ...
          bsCollapsePanel("Advanced Probe Settings",
                          ...
                          "and can identify problematic substrings that other alignment approaches ",
                          ...
                          tags$br(),
                          tags$br(),
                          tags$b("Min Prob Value:"),
                          " This parameter refers to the probability that a probe has no secondary structure. We use ",
                          tags$a("NUPACK", href = "https://piercelab-caltech.github.io/nupack-docs/", target = "_blank"),
                          " to compute this value for each of the probes hosted on PaintSHOP. By default,",
                          " PaintSHOP uses a minumum prob value of 0, allowing all probes by default. This can be changed ",
                          " using the slider, and the probe table and density plot will dynamically update.",
                          tags$hr(),
                          tags$b("Note:"),
                          ...
                          style = "primary"),
          bsCollapsePanel("Optimizing a Probe Set",
                          "In some instances, you may want to even out your probe set by selecting a certain ",
                          "number of probes per target. PaintSHOP offers two features for optimizing a probe ",
                          "set: 1) trim, and 2) unify number. For either option, use the slider to choose how many ",
                          "probes you want per target. The trim option simply ranks the probes for each target ",
                          "by off-target score, and keeps however many you need, removing the rest. The unify number ",
          ...
          bsCollapsePanel("Appending Sequences",
                          ...
                          "5' and 3' side. The SABER interface is simpler, since there are fewer ",
                          ...
                          tags$br(),
                          tags$br(),
                          tags$b("PaintSHOP Full Bridge Set:"), " a set of 800 new bridge sequences ",
                          ...
                          tags$br(),
                          tags$br(),
                          tags$b("PaintSHOP 5' Bridge Set:"), " 400 of the PaintSHOP bridge sequences ",
                          ...
                          tags$br(),
                          tags$br(),
                          tags$b("PaintSHOP 3' Bridge Set:"), " 400 of the PaintSHOP bridge sequences ",
                          ...
                          tags$br(),
                          tags$br(),
                          tags$b("Kishi et al. 2019 Bridges:"), " a set of 84 bridge sequences provided with the ",
                          tags$a("Kishi et al. 2019", href = "https://www.nature.com/articles/s41592-019-0404-0",
                                 target = "_blank"),
                          " publication in Nature Methods. These sequences are available for use on both the 5' and 3' ",
                          " Bridge regions.",
                          tags$br(),
                          tags$br(),
          ...
          bsCollapsePanel("Resources Available",
                          ...
                          "all probe sets and appending sets used in the backend of PaintSHOP are available ",
                          "for download here: ", 
                          tags$a("link", href = "https://github.com/beliveau-lab/PaintSHOP_resources",
                                 target = "_blank"),
                          tags$br(),
                          tags$br(),
